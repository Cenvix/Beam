 ...
 */
public class HorizontalMerchantButtons extends Button
{
    ...
    public HorizontalMerchantButtons(Context context, int index, String merchName) {
        super(context);
        this.index = index;
        this.merchName = merchName;

        Double d = Math.floor(getResources().getDisplayMetrics().widthPixels/3.5);
        int i = d.intValue();
        int j = getResources().getDisplayMetrics().heightPixels/6;
